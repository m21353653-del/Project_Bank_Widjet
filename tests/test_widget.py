...
@pytest.mark.parametrize("line, result", [
    ("Счет 23567898653092468198", "Счет **8198"),
    ("MasterCard 2200876587652343", "MasterCard 2200 87** **** 2343")
])
...
@pytest.mark.parametrize("line, result", [
    ...
    ("2024-03-11.671407", "11.671407.03.2024")
])
def test_lenght_get_date(line, result):
...
def test_empty_get_date():
    with pytest.raises(IndexError):
        get_date("")
        get_date("fggfdgd")
        get_date("fggfdgdfghuiwergTwih32944270934")